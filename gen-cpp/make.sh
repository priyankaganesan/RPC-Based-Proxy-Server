...
g++ -L/usr/local/lib server.o proxyserver.o constants.o types.o -o Proxyserver_server -lthrift
g++ -L/usr/local/lib client.o proxyserver.o constants.o types.o -o Proxyserver_client -lthrift
